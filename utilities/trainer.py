...
class PGTrainer(object):
    def __init__(self, args, model, env, logger):
        ...
        self.policy_scheduler = StepLR(self.policy_optimizer, step_size=self.args.lr_decay_step, gamma=self.args.lr_decay_gamma)
        self.value_scheduler = StepLR(self.value_optimizer, step_size=self.args.lr_decay_step, gamma=self.args.lr_decay_gamma)
